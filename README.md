...
|:three:|[airflow/run.sh](https://github.com/Zerohertz/k8s-on-premise/blob/DDNS/SVC/airflow/run.sh)|:o: [Apache Airflow](https://github.com/apache/airflow)|:white_check_mark: [Kubernetes Executor](https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/executor/kubernetes.html) 사용|
